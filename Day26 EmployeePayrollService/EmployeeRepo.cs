...
namespace Day26_EmployeePayrollService
{
    public class EmployeeRepo
    {
        ...
        public bool AddEmployee(EmployeeModel model)
        {
            ...
            {
                //var qury=values()
                SqlCommand command = new SqlCommand("SpAddEmployeeDetials", this.connection);
